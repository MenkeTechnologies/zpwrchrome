...
| Manifest | **MV3** |
| License | **MIT** |
| Test suite | **2849** `node:test` cases (JS) + 102 `cargo test` cases (Rust) |
...
Stock Node ≥ 20, no external dependencies. 2849 tests across 173 files. Covers:
