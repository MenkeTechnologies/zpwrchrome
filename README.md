...
[![Commands](https://img.shields.io/badge/commands-48-ff2a6d.svg)](#0x02-keyboard-commands)
...
| Manifest | **MV3** |
| License | **MIT** |
| Test suite | **2679** `node:test` cases (JS) + 74 `cargo test` cases (Rust) |
...
Stock Node ≥ 20, no external dependencies. 2679 tests across 168 files. Covers:
