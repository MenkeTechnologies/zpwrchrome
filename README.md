...
| Manifest | **MV3** |
| License | **MIT** |
| Test suite | **2993** `node:test` cases (JS) + 117 `cargo test` cases (Rust) |
...
Stock Node ≥ 20, no external dependencies. 2993 tests across 184 files. Covers:
