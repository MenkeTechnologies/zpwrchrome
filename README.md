...
| Manifest | **MV3** |
| License | **MIT** |
| Test suite | **2823** `node:test` cases (JS) + 102 `cargo test` cases (Rust) |
...
Stock Node ≥ 20, no external dependencies. 2823 tests across 174 files. Covers:
