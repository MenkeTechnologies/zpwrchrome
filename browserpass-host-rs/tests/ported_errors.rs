...
fn every_error_code_pins_to_protocol_md_value() {
    ...
    assert_eq!(Code::UnreadableDefaultPasswordStoreDefaultSettings.as_i32(),         17);
    assert_eq!(Code::UnableToListFilesInPasswordStore.as_i32(),                      18);
    assert_eq!(Code::UnableToDetermineRelativeFilePathInPasswordStore.as_i32(),      19);
    ...
    assert_eq!(Code::UnableToDetermineRelativeDirectoryPathInPasswordStore.as_i32(), 26);
