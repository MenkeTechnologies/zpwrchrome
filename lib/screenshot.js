...
const CAPTURE_GAP_MS = 400;     // > 500 ms throttle budget per capture
const MAX_TILES      = 60;
...
export async function screenshotFullPage(tab) {
  ...
  // chrome.scripting.executeScript and chrome.tabs.captureVisibleTab both
  // refuse chrome:// / chrome-extension:// / chromewebstore:// / view-source:
  // / data: / about: URLs. Bail loudly so the notification names the cause.
